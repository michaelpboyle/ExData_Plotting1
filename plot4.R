...
png("./plot4.png")
par(mfcol=c(2,2))
plot(hh_pwr_consump2$DateTm,hh_pwr_consump2$Global_active_power
...
plot(hh_pwr_consump2$DateTm,hh_pwr_consump2$Voltage
    ,xlab="datetime",ylab="Voltage",type="l")
plot(hh_pwr_consump2$DateTm,hh_pwr_consump2$Global_reactive_power
